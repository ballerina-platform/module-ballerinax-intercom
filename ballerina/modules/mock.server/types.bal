...
public type ExternalPageOk record {|
    *http:Ok;
    ExternalPage body;
|};
...
public type ReportingJobResponseOk record {|
    *http:Ok;
    ReportingJobResponse body;
|};
...
public type CallTranscriptListOk record {|
    *http:Ok;
    CallTranscriptList body;
|};
...
public type ErrorTooManyRequests record {|
...
public type ContentImportSourceOk record {|
    *http:Ok;
    ContentImportSource body;
|};
...
public type CustomChannelNotificationResponseOk record {|
    *http:Ok;
    CustomChannelNotificationResponse body;
|};
...
public type ContactWithPushOk record {|
    *http:Ok;
    ContactWithPush body;
|};
...
public type ConversationMessageOk record {|
    *http:Ok;
...
public type InternalArticleOk record {|
    *http:Ok;
    InternalArticle body;
|};
...
# Error details including code, message, and affected field
public type ErrorErrors record {
...
public type AiCallResponseOk record {|
    *http:Ok;
    AiCallResponse body;
|};
...
public type CustomObjectInstanceOk record {|
    *http:Ok;
    CustomObjectInstance body;
|};
...
public type ContactBlockedOk record {|
    *http:Ok;
    ContactBlocked body;
|};
